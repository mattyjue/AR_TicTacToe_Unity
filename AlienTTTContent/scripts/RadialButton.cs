...
public class RadialButton : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (hitTemp == hitInfo.collider && clicked == false && (hitInfo.collider.name == "returnMenu" || hitInfo.collider.name == "replayButton" || hitInfo.collider.name == "Plane1" || hitInfo.collider.name == "Plane2" || hitInfo.collider.name == "Plane3" || hitInfo.collider.name == "Plane4" || hitInfo.collider.name == "Plane5" || hitInfo.collider.name == "Plane6" || hitInfo.collider.name == "Plane7" || hitInfo.collider.name == "Plane8" || hitInfo.collider.name == "Plane9"))
            {
                ...
                else
                {
                    ...
                    if (hitInfo.collider.name == "replayButton")
                        GameObject.Find("scriptContainer").GetComponent<GameControl>().replay();
                    if (hitInfo.collider.name == "returnMenu")
                        GameObject.Find("scriptContainer").GetComponent<GameControl>().returnMenu();


                    GameObject.Find("scriptContainer").GetComponent<GameControl>().Clicked = true;
                }
